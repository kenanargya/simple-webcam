...
namespace WebcamCaptureApp
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (comboBoxWebcamList.Items.Count > 0)
            {
            ...
            {
                // Handle the case where no webcam devices are available.
                MessageBox.Show("No webcam devices found.");
                // You may want to disable the "Start" button or take other appropriate actions.
            }
        }
